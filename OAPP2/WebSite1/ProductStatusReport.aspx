<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="ProductStatusReport.aspx.cs" Inherits="ProductStatusReport" %>
        ...
        <div class="col-lg-12">
            ...
            <a href="AllReports.aspx"> <span ID="hideButton"  class="btn btn-round btn-danger" style="width:100px" >Back</span></a>
                <h4 class="mb">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Label"> Product Status Graph</asp:Label></h4>
